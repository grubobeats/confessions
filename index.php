		...
		<div class="row">
			<div class="col-sm-offset-2 col-sm-8">
				...
				<div class="row">
					<div class="col-sm-12">
						<ol class="breadcrumb">
						  <li class="active">Popular confessions</li>
						</ol>
					</div>
				</div>
				<div class="row">
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="btn-group btn-group-justified" role="group" aria-label="...">
											...
											<button type="button" class="btn btn-default"><i class="fa fa-thumbs-up"></i> Like <span class="badge">652</span></button>
											</div>
											<div class="btn-group" role="group">
											<button type="button" class="btn btn-default"><i class="fa fa-thumbs-down"></i> Dislike <span class="badge">11</span></button>
											</div>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="btn-group btn-group-justified" role="group" aria-label="...">
											...
											<div class="btn-group" role="group">
											<button type="button" class="btn btn-default"><i class="fa fa-vk"></i> VK</button>
											</div>
											<div class="btn-group" role="group">
