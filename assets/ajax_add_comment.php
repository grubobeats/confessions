<?php
	...
	if (mysqli_query($conn, $insert_comments)) {
		...
		$bot_url = "https://api.telegram.org/" . $bot_token . "/sendMessage?chat_id=" . $chat_id . "&text=`New comment on post ID: " . $post_id . "`, to open post [click here](http://www.moyatajna.ru/single_post.php?pid=" . $post_id . ") ```---``` Comment: ". $comment ."```---```To delete comment [click here](http://www.moyatajna.ru/assets/delete_comment.php?id=" . $comment_id .") &parse_mode=Markdown&disable_web_page_preview=true";
